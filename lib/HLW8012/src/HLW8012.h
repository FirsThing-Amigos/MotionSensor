...
class HLW8012 {
    ...
    public:
        ...
        void setResistors(double current, double voltage_upstream, double voltage_downstream,float current_callibration, float voltage_callibration, float power_callibration);
    ...
    private:
        ...
        void _calculateDefaultMultipliers(float current_callibration, float voltage_callibration, float power_callibration);
